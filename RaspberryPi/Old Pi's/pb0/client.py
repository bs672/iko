...
class Client(mqtt.Client):
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        for tier in self.tiers:
            ...
            self.subscribe("$aws/things/" + tier.name + "/shadow/update/delta")
    ...
    def on_message(self, mosq, obj, msg):
        try:
            ...
            for tier in self.tiers:
                ...
                elif (msg.topic == tier.name + "/change_in_out"):
                    tier.change_in_out(payload)
                elif (msg.topic == tier.name + "/change_circ_heat"):
                    tier.change_in_out(change_circ_heat)
                elif (msg.topic == tier.name + "/change_buffer"):
                    tier.change_in_out(change_buffer)
